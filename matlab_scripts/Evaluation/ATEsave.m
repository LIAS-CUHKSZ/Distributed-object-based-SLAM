function [] = ATEsave(real_path_all, X, landmarks, Eff_Range,num_method,datasetname)
...
for i=1:n
   ...
   time=X.t;
   robotname=['robot',num2str(i)];
    [T_IMU_est, p_IMU_est]=get_estimator_Tt(estX, time,datasetname,robotname);
